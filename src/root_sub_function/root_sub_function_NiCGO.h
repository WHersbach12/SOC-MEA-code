...
class RootSubFunctionNiCGO : public RootSubFunctionPorous{
private:
    int rank;
    ...
    double Percolation_CGO;
    const double Phi_CGO = 0.46;
    const double Phi_Ni = 1-Phi_CGO;
...
public:
    RootSubFunctionNiCGO(   const int _rank, const std::vector<double>& _x_center,const std::vector<double>& _x_face,

...
class RootSubFunctionLSMYSZ : public RootSubFunctionPorous{
private:
    int rank;
    bool galvanostatic;
    ...
    int preceding_layer_oxygen_anion_index;    int oxygen_index = -1;
    ...
    double Percolation_LSM;
    double Percolation_YSZ;
    const double Phi_YSZ = 0.51;
    const double Phi_LSM = 1-Phi_YSZ;
...
public:
    RootSubFunctionLSMYSZ(const int _rank, const std::vector<double>& _x_center,const std::vector<double>& _x_face,
    ...
    ~RootSubFunctionLSMYSZ() override;    
